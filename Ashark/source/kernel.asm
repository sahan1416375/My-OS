...
;===================================================================
	...
	BITS 16
	%DEFINE SHOS_VER '1.0.0'	 ;OS version number
	%DEFINE SHOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as SHOS and its programs
...
option_screen:
	...
	os_init_msg		db '--------------------------Welcome to SHOS----------------------------', 0
	os_version_msg		db 'Version ', SHOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', SHOS_VER, 0

	dialog_string_1		db 'Welcome to SHOS Operating System', 0
	dialog_string_2		db 'Please select Go for HardwareInfo or', 0
...
os_draw_background1:
	...
	mov cx, 01110000b		; Colour: white text on light blue
